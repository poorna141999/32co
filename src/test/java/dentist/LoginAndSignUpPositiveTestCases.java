...
public class LoginAndSignUpPositiveTestCases extends Common {
	...
	@Test(groups = { "Regression", "Dentist", "Positive" })
	public void DenitstLoginLogoutToApplication() {
		...
		DentistDashboardPage.logoutApplication();
	...
	@Test(groups = { "Functional", "Dentist", "Positive" })
	public void DenitstSignUpToApplication2() {
		...
		for (String dataset : datasets) {
			...
			DentistLoginPage = DentistApplication.open32CoApplication();
			DentistDashboardPage = DentistLoginPage.loginToApplicationnewUser();
			DentistLoginPage.selectInitialDetailsNoFlow();
		}
		DentistApplication.close();
		datasetEnd();
	}
	...
	@Test(groups = { "Regression", "Dentist", "Positive" })
	public void DenitstValidateUISingUpAndLoginPage() {
	...
	@Ignore
	public void DenitstValidateNotReadyToJoinPopup() {
	...
	public void ValidateForgotPasswordFunctionality() {
		...
		for (String dataset : datasets) {
			...
			DentistLoginPage.validateForgotPassword(data);
			DentistApplication.close();
